...
public class AuthTests extends TestBase {
    ...
    @Test
    @DisplayName("Отображается экран ввода кода, при корректно введенном номере телефона")
    ...
    @Test
    @DisplayName("При неверно введенном коде подтверждения отображается ошибка")
